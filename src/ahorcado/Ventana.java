...
public class Ventana extends Canvas {
	...
	public void paint(Graphics g) {
		...
		//Establecer la imagen de fondo. Si el juego est� en modo navidad, coger� el fondo navide�o
		...
		//Si el juego est� en modo navidad le dibujar� un gorrito al personaje
		if (Juego.isNavidad() == true) {
		...
		//Intentos restantes:
		g.drawString("Nº de errores: " + Juego.getFallos() + "/6", 45, 448);
		...
		if (Juego.isCoincidencia() == true ) {
			...
			//Poner un tono m�s brillante si el modo navide�o est� activado
			if (Juego.isNavidad() == true) {
		...
		switch (Juego.getFallos()) {
			...
			case 6:{
				...
				//Gorro (si el modo navide�o est� activado). Lo dibujo otra vez para que se superponga a la cabeza en rojo
				if (Juego.isNavidad() == true) {
