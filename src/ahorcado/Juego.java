...
public class Juego {
	...
	private static boolean navidadEscape = false; //Este boolean servir� para la secuencia de escape del bucle del juego cuando el jugador quiera usar el cheat "jingle bells"
	...
	public static void bucleJuego (String letras[]) {
		...
		do {
			...
			//"godmode on" o "godmode off" ese intento se dejar� en blanco
			...
			//Si el jugador activa el modo navide�o. Solo se puede activar una vez por partida
			if (intento.equalsIgnoreCase("jingle bells") && navidad == false) {
				...
				//Cheat para desactivar el tema navide�o (no resetea el juego)
	...
	//M�todo para resetear juego cuando el usuario quiera jugar otra vez o use el cheat "jingle bells"
