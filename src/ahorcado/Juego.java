...
public class Juego {
	...
	public static void bucleJuego (String letras[]) {
		...
		do {
			...
			//Si el jugador activa el modo navideÒo. Solo se puede activar una vez por partida
			if (intento.equalsIgnoreCase("jingle bells") && navidad == false) {
				...
				//Cheat para desactivar el tema navideÒo (no resetea el juego)
	...
	//MÈtodo para resetear juego cuando el usuario quiera jugar otra vez o use el cheat "jingle bells"
