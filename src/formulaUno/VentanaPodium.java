...
public class VentanaPodium extends Canvas {
	...
	public VentanaPodium(Vehiculo clasificacion[] ) {
		...
		JFrame ventanaPodium = new JFrame("P�dium");
		
		//Establezco las dimensiones de la ventana
		ventanaPodium.setBounds(600,300,ANCHO,ALTO);
		
		//Creaci�n del panel principal de la ventana y le añadimos el objeto Ventana (el canvas)
	...
	public void paint(Graphics g) {
		...
		//Dibujar los veh�culos con los nombres por encima (el nombre del tercero se escribe m�s a la derecha que el de los dem�s para que no se superponga con la imagen
